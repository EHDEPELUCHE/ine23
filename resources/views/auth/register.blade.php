                ...
                <div class="modal-body p-5 pt-0">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-floating mb-3">
                            <x-input id="name" class="form-control rounded-3" placeholder="{{ __('auth.Name') }}" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                        ...
                        <div class="form-floating mb-3">
                            <x-input id="password" class="form-control rounded-3" type="password" placeholder="{{ __('auth.Password') }}" name="password" required autocomplete="new-password" />
                            <x-label for="password" value="{{ __('auth.Password') }}" />
                        </div>

                        <div class="form-floating mb-3">
                            <x-input id="password_confirmation" class="form-control rounded-3" type="password" placeholder="{{ __('auth.Confirm Password') }}" name="password_confirmation" required autocomplete="new-password" />
